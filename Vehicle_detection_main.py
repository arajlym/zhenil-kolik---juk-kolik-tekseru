...
print("Avtomobildi sanau jane anyqtau")
    ...
    if ret==True:
        ...
        for i in cars:
            ...
            if line_down+20<= i.getY() <= line_up-20:
               ...
               if a >= 0:
                     cv2.putText(frame, "Gruzovik", (i.getX(), i.getY()), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
               else:
                     cv2.putText(frame, "zhenil mashina", (i.getX(), i.getY()), font, 1, (255, 255, 255), 2, cv2.LINE_AA)
